    ...
    return (
        <footer id="footer" className="footer">
            ...
            <div className="row">
                ...
                <p>The material contained in this website is not investment advice, and does not constitute an offer to buy or sell any security. Opinions expressed are not factual in nature and are subject to change at any time. Material based on information from third party sources is believed reliable, but no representation is made that it is accurate or complete, and should not be relied upon for an investment decision. Past performance is not an indication of future performance.</p>
                </div>
            </div>
            <div className="container row s-footer__bottom hide-on-tab" style={{justifyContent: "space-between"}}>
                <div className="col-lg-12" style={{display: "contents"}}>
                    <div className="ss-copyright">
                        <span className="ss-copyright">© Copyright Venexus 2023 - <script>document.write(new Date().getFullYear());</script> All rights reserved.</span> 
                        <span><a href="#">Privacy Policy</a></span>
                        <span><a href="#">Terms of Use</a></span>
                        <span><a href="#">Data Protection Disclosure</a></span>
                        <span><a href="#">Regulatory Disclosures</a></span>
                    </div>
                    <ul className="s-footer__social" style={{alignItems: "end"}}>
                    <li>
                        <a href="">
                            <svg 
